...
export const translations: Record<Language, TranslationKeys> = {
  ...
  zh: {
    ...
    notFound: { title: '未找到NFT', description: '抱歉，您正在寻找的NFT不存在或已被移动。', backToGallery: '返回画廊', goBack: '返回' },
  ...
  hi: {
    ...
    notFound: { title: 'NFT नहीं मिला', description: 'क्षमा करें, आप जो NFT खोज रहे हैं वह मौजूद नहीं है या स्थानांतरित कर दिया गया है।', backToGallery: 'गैलरी पर वापस जाएं', goBack: 'वापस जाएं' },
    galleryErrors: { failedToFetch: 'NFTs प्राप्त करने में विफल', unknown: 'अज्ञात त्रुटि', errorHeading: 'NFTs लोड करने में त्रुटि', retryButton: 'पुनः प्रयास करें' },
    userProfile: { notFoundTitle: 'प्रोफ़ाइल नहीं मिली', notFoundDescription: 'इस उपयोगकर्ता के लिए प्रोफ़ाइल लोड या बनाने में असमर्थ। कृपया बाद में पुनः प्रयास करें।', backButton: 'गैलरी पर वापस जाएं', backToGallery: 'गैलरी पर वापस जाएं', website: 'वेबसाइट', communityPoints: 'समुदाय अंक', nftsOwned: 'स्वामित्व वाले NFT', memberSince: 'सदस्य बनने की तारीख', nftCollection: 'NFT संग्रह', loadingNfts: 'NFTs लोड हो रहे हैं...', noNftsTitle: 'कोई NFT नहीं मिला', noNftsDescription: 'इस उपयोगकर्ता के पास अभी तक Power Grinders संग्रह का कोई NFT नहीं है' },
    nftDetail: { registeredMember: 'पंजीकृत सदस्य', viewProfile: 'प्रोफ़ाइल देखें', leaderboard: 'लीडरबोर्ड', shareOnTwitter: 'Twitter पर साझा करें', tweetTemplate: '@Power_Grinders NFT संग्रह से {name} #{number} देखें! 🔥' },
    profileEditor: { editButton: 'प्रोफ़ाइल संपादित करें', heading: 'प्रोफ़ाइल संपादित करें', displayNameLabel: 'प्रदर्शन नाम', displayNamePlaceholder: 'आपका प्रदर्शन नाम', displayNameHelp: '2-30 वर्ण। डिफ़ॉल्ट नाम उपयोग करने के लिए खाली छोड़ दें।', profilePictureLabel: 'प्रोफ़ाइल चित्र', uploadImage: 'छवि अपलोड करें', uploading: 'अपलोड हो रहा है...', remove: 'हटाएं', profilePictureHelp: 'एक वर्ग छवि अपलोड करें (500x500px अनुशंसित, अधिकतम 5MB)', bannerImageLabel: 'बैनर छवि', uploadBanner: 'बैनर अपलोड करें', removeBanner: 'बैनर हटाएं', bannerImageHelp: 'एक चौड़ी बैनर छवि अपलोड करें (1500x500px अनुशंसित, अधिकतम 5MB)', bioLabel: 'बायो / विवरण', bioPlaceholder: 'हमें अपने बारे में बताएं...', charCount: '{count}/500 वर्ण', socialLinksHeading: 'सोशल लिंक', twitterLabel: 'Twitter हैंडल', twitterPlaceholder: 'उपयोगकर्तानाम', discordLabel: 'Discord उपयोगकर्तानाम', discordPlaceholder: 'उपयोगकर्तानाम#1234', telegramLabel: 'Telegram उपयोगकर्तानाम', telegramPlaceholder: 'उपयोगकर्तानाम', telegramHelp: '5-32 वर्ण, एक अक्षर से शुरू होना चाहिए', websiteLabel: 'वेबसाइट', websitePlaceholder: 'https://yourwebsite.com', saving: 'सहेजा जा रहा है...', saveButton: 'परिवर्तन सहेजें', cancelButton: 'रद्द करें', errorFileSize: 'फ़ाइल आकार 5MB से कम होना चाहिए', errorFileType: 'फ़ाइल प्रकार JPG, PNG, WEBP, या GIF होना चाहिए', errorUploadFailed: 'छवि अपलोड करने में विफल', errorUpdateFailed: 'प्रोफ़ाइल अपडेट करने में विफल', errorSaveFailed: 'प्रोफ़ाइल सहेजने में विफल' },
    displayNameEditor: { editButton: 'नाम संपादित करें', placeholder: 'अपना प्रदर्शन नाम दर्ज करें', help: '2-30 वर्ण। अक्षर, संख्या, स्थान, _ और - की अनुमति है।', errorLength: 'नाम 2-30 वर्णों का होना चाहिए', errorUpdateFailed: 'नाम अपडेट करने में विफल', errorSaveFailed: 'सहेजने में विफल। कृपया पुनः प्रयास करें।' },
    auth: { connectTooltip: 'Twitter, Discord, Gmail या Solana वॉलेट से कनेक्ट करें' },
  },
  ko: {
    ...
    notFound: { title: 'NFT를 찾을 수 없음', description: '죄송합니다. 찾으시는 NFT가 존재하지 않거나 이동되었습니다.', backToGallery: '갤러리로 돌아가기', goBack: '돌아가기' },
    galleryErrors: { failedToFetch: 'NFT를 가져오지 못했습니다', unknown: '알 수 없는 오류', errorHeading: 'NFT 로드 오류', retryButton: '다시 시도' },
    userProfile: { notFoundTitle: '프로필을 찾을 수 없음', notFoundDescription: '이 사용자의 프로필을 로드하거나 생성할 수 없습니다. 나중에 다시 시도하십시오.', backButton: '갤러리로 돌아가기', backToGallery: '갤러리로 돌아가기', website: '웹사이트', communityPoints: '커뮤니티 포인트', nftsOwned: '소유한 NFT', memberSince: '가입일', nftCollection: 'NFT 컬렉션', loadingNfts: 'NFT 로딩 중...', noNftsTitle: 'NFT를 찾을 수 없음', noNftsDescription: '이 사용자는 아직 Power Grinders 컬렉션의 NFT를 소유하고 있지 않습니다' },
    nftDetail: { registeredMember: '등록 회원', viewProfile: '프로필 보기', leaderboard: '리더보드', shareOnTwitter: 'Twitter에 공유', tweetTemplate: '@Power_Grinders NFT 컬렉션의 {name} #{number}를 확인하세요! 🔥' },
    profileEditor: { editButton: '프로필 편집', heading: '프로필 편집', displayNameLabel: '표시 이름', displayNamePlaceholder: '표시 이름', displayNameHelp: '2-30자. 기본 이름을 사용하려면 비워 두세요.', profilePictureLabel: '프로필 사진', uploadImage: '이미지 업로드', uploading: '업로드 중...', remove: '제거', profilePictureHelp: '정사각형 이미지 업로드(권장 500x500px, 최대 5MB)', bannerImageLabel: '배너 이미지', uploadBanner: '배너 업로드', removeBanner: '배너 제거', bannerImageHelp: '와이드 배너 이미지 업로드(권장 1500x500px, 최대 5MB)', bioLabel: '소개 / 설명', bioPlaceholder: '자신에 대해 알려주세요...', charCount: '{count}/500자', socialLinksHeading: '소셜 링크', twitterLabel: 'Twitter 핸들', twitterPlaceholder: '사용자명', discordLabel: 'Discord 사용자명', discordPlaceholder: '사용자명#1234', telegramLabel: 'Telegram 사용자명', telegramPlaceholder: '사용자명', telegramHelp: '5-32자, 문자로 시작해야 합니다', websiteLabel: '웹사이트', websitePlaceholder: 'https://yourwebsite.com', saving: '저장 중...', saveButton: '변경 사항 저장', cancelButton: '취소', errorFileSize: '파일 크기는 5MB 미만이어야 합니다', errorFileType: '파일 형식은 JPG, PNG, WEBP 또는 GIF여야 합니다', errorUploadFailed: '이미지 업로드 실패', errorUpdateFailed: '프로필 업데이트 실패', errorSaveFailed: '프로필 저장 실패' },
    displayNameEditor: { editButton: '이름 편집', placeholder: '표시 이름 입력', help: '2-30자. 문자, 숫자, 공백, _ 및 - 허용.', errorLength: '이름은 2-30자여야 합니다', errorUpdateFailed: '이름 업데이트 실패', errorSaveFailed: '저장 실패. 다시 시도하십시오.' },
    auth: { connectTooltip: 'Twitter, Discord, Gmail 또는 Solana 지갑으로 연결' },
  },
  it: {
    nav: {
      home: 'Home',
    ...
    notFound: { title: 'NFT Non Trovato', description: 'Spiacenti, l\'NFT che stai cercando non esiste o è stato spostato.', backToGallery: 'Torna alla Galleria', goBack: 'Indietro' },
    galleryErrors: { failedToFetch: 'Impossibile recuperare gli NFT', unknown: 'Errore sconosciuto', errorHeading: 'Errore Caricamento NFT', retryButton: 'Riprova' },
    userProfile: { notFoundTitle: 'Profilo Non Trovato', notFoundDescription: 'Impossibile caricare o creare il profilo per questo utente. Riprova più tardi.', backButton: 'Torna alla Galleria', backToGallery: 'Torna alla Galleria', website: 'Sito Web', communityPoints: 'Punti Comunità', nftsOwned: 'NFT Posseduti', memberSince: 'Membro dal', nftCollection: 'Collezione NFT', loadingNfts: 'Caricamento NFT...', noNftsTitle: 'Nessun NFT trovato', noNftsDescription: 'Questo utente non possiede ancora NFT dalla collezione Power Grinders' },
    nftDetail: { registeredMember: 'Membro Registrato', viewProfile: 'Visualizza Profilo', leaderboard: 'Classifica', shareOnTwitter: 'Condividi su Twitter', tweetTemplate: 'Guarda {name} #{number} dalla Collezione NFT @Power_Grinders! 🔥' },
    profileEditor: { editButton: 'Modifica Profilo', heading: 'Modifica Profilo', displayNameLabel: 'Nome Visualizzato', displayNamePlaceholder: 'Il tuo nome visualizzato', displayNameHelp: '2-30 caratteri. Lascia vuoto per usare il nome predefinito.', profilePictureLabel: 'Immagine Profilo', uploadImage: 'Carica Immagine', uploading: 'Caricamento...', remove: 'Rimuovi', profilePictureHelp: 'Carica un\'immagine quadrata (500x500px consigliati, max 5MB)', bannerImageLabel: 'Immagine Banner', uploadBanner: 'Carica Banner', removeBanner: 'Rimuovi Banner', bannerImageHelp: 'Carica un\'immagine banner ampia (1500x500px consigliati, max 5MB)', bioLabel: 'Bio / Descrizione', bioPlaceholder: 'Raccontaci di te...', charCount: '{count}/500 caratteri', socialLinksHeading: 'Link Social', twitterLabel: 'Handle Twitter', twitterPlaceholder: 'nomeutente', discordLabel: 'Nome Utente Discord', discordPlaceholder: 'nomeutente#1234', telegramLabel: 'Nome Utente Telegram', telegramPlaceholder: 'nomeutente', telegramHelp: '5-32 caratteri, deve iniziare con una lettera', websiteLabel: 'Sito Web', websitePlaceholder: 'https://tuosito.com', saving: 'Salvataggio...', saveButton: 'Salva Modifiche', cancelButton: 'Annulla', errorFileSize: 'La dimensione del file deve essere inferiore a 5MB', errorFileType: 'Il tipo di file deve essere JPG, PNG, WEBP o GIF', errorUploadFailed: 'Caricamento immagine fallito', errorUpdateFailed: 'Aggiornamento profilo fallito', errorSaveFailed: 'Salvataggio profilo fallito' },
    displayNameEditor: { editButton: 'Modifica Nome', placeholder: 'Inserisci il tuo nome visualizzato', help: '2-30 caratteri. Lettere, numeri, spazi, _ e - consentiti.', errorLength: 'Il nome deve essere di 2-30 caratteri', errorUpdateFailed: 'Aggiornamento nome fallito', errorSaveFailed: 'Salvataggio fallito. Riprova.' },
    auth: { connectTooltip: 'Connetti con Twitter, Discord, Gmail o wallet Solana' },
  },
  tr: {
    nav: {
      home: 'Ana Sayfa',
    ...
    notFound: { title: 'NFT Bulunamadı', description: 'Üzgünüz, aradığınız NFT mevcut değil veya taşındı.', backToGallery: 'Galeriye Dön', goBack: 'Geri Dön' },
    galleryErrors: { failedToFetch: 'NFT\'ler alınamadı', unknown: 'Bilinmeyen hata', errorHeading: 'NFT\'ler Yüklenirken Hata', retryButton: 'Tekrar Dene' },
    userProfile: { notFoundTitle: 'Profil Bulunamadı', notFoundDescription: 'Bu kullanıcının profili yüklenemedi veya oluşturulamadı. Lütfen daha sonra tekrar deneyin.', backButton: 'Galeriye Dön', backToGallery: 'Galeriye Dön', website: 'Web Sitesi', communityPoints: 'Topluluk Puanları', nftsOwned: 'Sahip Olunan NFT\'ler', memberSince: 'Üyelik Başlangıcı', nftCollection: 'NFT Koleksiyonu', loadingNfts: 'NFT\'ler yükleniyor...', noNftsTitle: 'Henüz NFT Yok', noNftsDescription: 'Bu kullanıcı henüz Power Grinders NFT\'sine sahip değil.' },
    nftDetail: { registeredMember: 'Kayıtlı Üye', viewProfile: 'Profili Görüntüle', leaderboard: 'Liderlik Tablosu', shareOnTwitter: 'Twitter\'da Paylaş', tweetTemplate: 'Power Grinders koleksiyonumdan {name} ile tanışın! 🔥 Apokalips sonrası en elit topluluk. #PowerGrinders #NFT' },
    profileEditor: { editButton: 'Profili Düzenle', heading: 'Profilini Düzenle', displayNameLabel: 'Görünen Ad', displayNamePlaceholder: 'Adınızı girin', displayNameHelp: 'Bu, platformda gösterilecek adınızdır', profilePictureLabel: 'Profil Resmi', uploadImage: 'Resim Yükle', uploading: 'Yükleniyor...', remove: 'Kaldır', profilePictureHelp: 'Maksimum 2MB. Desteklenen: JPG, PNG, GIF', bannerImageLabel: 'Banner Resmi', uploadBanner: 'Banner Yükle', removeBanner: 'Banner\'ı Kaldır', bannerImageHelp: 'Maksimum 5MB. Önerilen: 1500x500px', bioLabel: 'Biyografi', bioPlaceholder: 'Kendiniz hakkında bir şeyler söyleyin...', charCount: 'karakter', socialLinksHeading: 'Sosyal Bağlantılar', twitterLabel: 'Twitter Kullanıcı Adı', twitterPlaceholder: '@kullaniciadi', discordLabel: 'Discord Kullanıcı Adı', discordPlaceholder: 'kullaniciadi#1234', telegramLabel: 'Telegram Kullanıcı Adı', telegramPlaceholder: '@kullaniciadi', telegramHelp: '@işareti ile başlayın', websiteLabel: 'Web Sitesi', websitePlaceholder: 'https://example.com', saving: 'Kaydediliyor...', saveButton: 'Değişiklikleri Kaydet', cancelButton: 'İptal', errorFileSize: 'Dosya boyutu sınırı aşıldı', errorFileType: 'Geçersiz dosya türü', errorUploadFailed: 'Yükleme başarısız', errorUpdateFailed: 'Profil güncellenemedi', errorSaveFailed: 'Değişiklikler kaydedilemedi' },
    displayNameEditor: { editButton: 'Düzenle', placeholder: 'Adınızı girin', help: 'Bu, platformda gösterilecek adınızdır', errorLength: 'Ad 1-50 karakter arası olmalıdır', errorUpdateFailed: 'Ad güncellenemedi', errorSaveFailed: 'Değişiklikler kaydedilemedi' },
    auth: { connectTooltip: 'Profil özellikleri için bağlanın' },
  },
  pt: {
    nav: {
      home: 'Início',
    ...
    notFound: { title: 'NFT Não Encontrado', description: 'Desculpe, o NFT que você procura não existe ou foi movido.', backToGallery: 'Voltar à Galeria', goBack: 'Voltar' },
    galleryErrors: { failedToFetch: 'Falha ao buscar NFTs', unknown: 'Erro desconhecido', errorHeading: 'Erro ao Carregar NFTs', retryButton: 'Tentar Novamente' },
    userProfile: { notFoundTitle: 'Perfil Não Encontrado', notFoundDescription: 'Não foi possível carregar ou criar o perfil deste usuário. Por favor, tente novamente mais tarde.', backButton: 'Voltar à Galeria', backToGallery: 'Voltar à Galeria', website: 'Site', communityPoints: 'Pontos da Comunidade', nftsOwned: 'NFTs Possuídos', memberSince: 'Membro Desde', nftCollection: 'Coleção NFT', loadingNfts: 'Carregando NFTs...', noNftsTitle: 'Nenhum NFT Ainda', noNftsDescription: 'Este usuário ainda não possui nenhum NFT Power Grinders.' },
    nftDetail: { registeredMember: 'Membro Registrado', viewProfile: 'Ver Perfil', leaderboard: 'Classificação', shareOnTwitter: 'Compartilhar no Twitter', tweetTemplate: 'Conheça {name} da minha coleção Power Grinders! 🔥 A comunidade de elite mais exclusiva pós-apocalipse. #PowerGrinders #NFT' },
    profileEditor: { editButton: 'Editar Perfil', heading: 'Edite seu Perfil', displayNameLabel: 'Nome de Exibição', displayNamePlaceholder: 'Digite seu nome', displayNameHelp: 'Este é o nome que será exibido na plataforma', profilePictureLabel: 'Foto de Perfil', uploadImage: 'Enviar Imagem', uploading: 'Enviando...', remove: 'Remover', profilePictureHelp: 'Máximo 2MB. Suportado: JPG, PNG, GIF', bannerImageLabel: 'Imagem de Banner', uploadBanner: 'Enviar Banner', removeBanner: 'Remover Banner', bannerImageHelp: 'Máximo 5MB. Recomendado: 1500x500px', bioLabel: 'Biografia', bioPlaceholder: 'Conte-nos sobre você...', charCount: 'caracteres', socialLinksHeading: 'Links Sociais', twitterLabel: 'Usuário do Twitter', twitterPlaceholder: '@usuario', discordLabel: 'Usuário do Discord', discordPlaceholder: 'usuario#1234', telegramLabel: 'Usuário do Telegram', telegramPlaceholder: '@usuario', telegramHelp: 'Comece com @', websiteLabel: 'Site', websitePlaceholder: 'https://exemplo.com', saving: 'Salvando...', saveButton: 'Salvar Alterações', cancelButton: 'Cancelar', errorFileSize: 'Tamanho do arquivo excedido', errorFileType: 'Tipo de arquivo inválido', errorUploadFailed: 'Falha no envio', errorUpdateFailed: 'Falha ao atualizar perfil', errorSaveFailed: 'Falha ao salvar alterações' },
    displayNameEditor: { editButton: 'Editar', placeholder: 'Digite seu nome', help: 'Este é o nome que será exibido na plataforma', errorLength: 'O nome deve ter entre 1 e 50 caracteres', errorUpdateFailed: 'Falha ao atualizar nome', errorSaveFailed: 'Falha ao salvar alterações' },
    auth: { connectTooltip: 'Conecte-se para recursos de perfil' },
  },
};
